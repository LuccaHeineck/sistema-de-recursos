...
const Menu = () => {
  ...
  return (
    <div className="bg-customGreyDark text-white p-4 h-screen w-72 fixed left-0 top-0 rounded-tr-xl overflow-y-auto no-scrollbar flex flex-col justify-between">
