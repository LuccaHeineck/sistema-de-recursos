...
urlpatterns = [
    ...
    path('tipo_bem/cadastrar/', views.TipoBemCreateView.as_view(), name='criar-tipobem'),
    path('tipo_bem/atualizar/<int:pk>/', views.TipoBemUpdateView.as_view(), name='atualizar-tipobem'),
    path('tipo_bem/deletar/<int:pk>/', views.TipoBemDeleteView.as_view(), name='deletar-tipobem')
]